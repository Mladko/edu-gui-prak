...
public class DatenCheck {
    ...
    private void setDefaults() {
        ...
        System.out.println(this.alRegions.contains(" Murcia".trim()) + " Murcia".trim());
    }
    ...
    public int checkFormat(int pos, String key, String token) {
        ...
        if (key.equals("Wein")) {
            ...
            // Da die Wahrscheinlichkeit gering ist, dass jemand Zusammenhänge zwischen Land und Region verfälschen kann, wurde darauf verzichtet diese zu prüfen.
...
//                }
            ...
            if (!token.matches(this.kundenFormat.get(pos))) errCode = pos;
        }
        return errCode;
    }
}
